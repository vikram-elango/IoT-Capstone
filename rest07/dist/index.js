...
function main() {
    ...
    apiRouter2.get('/power', (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        let from = req.query.from ? req.query.from.toString() : '1970-01-01 00:00:00.000';
        let to = req.query.to ? req.query.to.toString() : '9999-12-31 23:59:59.999';
        let last = convertDataToInteger(req.query.last, 5000); // Fetch last 100 entries by default
    ...
    apiRouter2.get('/xyz', (req, res) => __awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c;
        // Default values for query parameters
        let from = req.query.from ? req.query.from.toString() : '1970-01-01 00:00:00.000';
        let to = req.query.to ? req.query.to.toString() : '9999-12-31 23:59:59.999';
        let last = convertDataToInteger(req.query.last, 1); // Fetch the latest value by default
    ...
    `;
        ...
        try {
            ...
            const xyzData = {
                x: ((_a = rows.find(row => row.metric === 'HMI_GVL.M.Rob1.ROBOTPOS.X')) === null || _a === void 0 ? void 0 : _a.value) || 0,
                y: ((_b = rows.find(row => row.metric === 'HMI_GVL.M.Rob1.ROBOTPOS.Y')) === null || _b === void 0 ? void 0 : _b.value) || 0,
                z: ((_c = rows.find(row => row.metric === 'HMI_GVL.M.Rob1.ROBOTPOS.Z')) === null || _c === void 0 ? void 0 : _c.value) || 0,
